...
SECRET_KEY = 'django-insecure-!w2hi)td3xs#rf(t_ahz&lq*=3j*&@0tk*0b#sbe^re0!hcj33'
...
# Fallback to SQLite if MongoDB is not available (for development/testing)
try:
    import pymongo
...
# Session configuration for language persistence
